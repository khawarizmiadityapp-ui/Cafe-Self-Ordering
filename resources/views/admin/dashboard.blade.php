...
@section('content')
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            <div class="stat-card-header">
                <span class="stat-card-title" style="color: var(--warning);">Sedang Diproses</span>
            ...
            <div class="stat-val" style="color: var(--warning);">{{ $stats['order_diproses'] }} <span class="stat-unit">Order</span></div>
        </div>

        <div class="stat-card">
            <div class="stat-card-header">
                <span class="stat-card-title" style="color: var(--success);">Order Selesai</span>
            ...
            <div class="stat-val" style="color: var(--success);">{{ $stats['order_selesai'] }} <span class="stat-unit">Order</span></div>
        </div>
    ...
    <div class="admin-split-2col">
        ...
        <div class="dashboard-panel">
            <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 16px;">
                <h3 style="font-size: 1.1rem; font-weight: 800; color: var(--primary); display: flex; align-items: center; gap: 8px;">
                    ...
                    <tbody>
                        @forelse($topProducts as $item)
                            <tr>
                                ...
                                <td style="font-weight: 800; color: var(--accent-dark); white-space: nowrap;">{{ $item->total_qty }} porsi</td>
                                <td style="font-weight: 800; color: var(--primary); text-align: right; white-space: nowrap;">Rp{{ number_format($item->total_sales, 0, ',', '.') }}</td>
                            </tr>
                        @empty
                            <tr>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        @forelse($recentOrders as $ord)
                            <tr>
                                <td style="font-weight: 700; color: var(--primary); white-space: nowrap;">{{ $ord->order_number }}</td>
                                <td style="font-weight: 700; white-space: nowrap;">{{ $ord->table ? 'Meja ' . $ord->table->table_number : 'Takeaway' }}</td>
                                <td style="font-weight: 800; white-space: nowrap;">Rp{{ number_format($ord->total_amount, 0, ',', '.') }}</td>
