...
@section('content')
    <div class="page-header">
        <div>
            ...
            <p style="font-size: 0.9rem; color: var(--text-muted);">Masukkan detail menu makanan atau minuman baru</p>
        </div>
    ...
    <div style="background: #ffffff; padding: 28px; border-radius: var(--radius-md); border: 1px solid var(--border-color); max-width: 680px; box-shadow: var(--shadow-sm);">
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="form-label">Kategori Menu <span style="color: var(--danger);">*</span></label>
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" placeholder="Contoh: Es Kopi Susu Gula Aren" required>
            </div>

            <div class="form-group">
                <label class="form-label">Harga (Rp) <span style="color: var(--danger);">*</span></label>
                <input type="number" name="price" class="form-control" placeholder="15000" min="0" step="500" required>
            </div>

            <div class="form-group">
                <label class="form-label">Deskripsi Menu</label>
                <textarea name="description" class="form-control" rows="3" placeholder="Penjelasan singkat bahan atau cita rasa menu"></textarea>
            </div>

            <div class="form-group">
                <label class="form-label">URL Foto Menu (Unsplash / Direct Link)</label>
